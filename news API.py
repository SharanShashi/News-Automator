...
class NewsApp:
    ...
    def __init__(self):
        ...
        # fetch data
        self.data = requests.get('https://newsapi.org/v2/top-headlines?country=in&apiKey=6c6c39d4a147401ea4446d239d0cfc40').json()
        # intital GUI load
        self.load_gui()
    ...
    def load_gui(self):
        ...
        self.root.title('My NEWS API APP')
    ...
    def load_news_item(self,index):
        ...
        try:
            ...
            img_url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTfId1JtxLoc7bKkkSfmxtlc9ti_2Hhhcpm_7cd5yWQZANmFi0pELuxzHUgf_bzo4NSAuM&usqp=CAU'
            raw_data = urlopen(img_url).read()
            im = Image.open(io.BytesIO(raw_data)).resize((350,250))
            photo = ImageTk.PhotoImage(im)
